...
void BossKnight::Initialize()
{
    ...
    CollisionManager::GetInstance()->FindCollider(name_ + "Weapon")->category_ =
        CollisionCategory::EnemyWeapon;
    ...
    states_[EnemyStateName::Idle] =
        std::make_unique<BossStateCombatIdle>(sensor_.get(), movement_.get(), kMaxHp);
    states_[EnemyStateName::Move] =
        std::make_unique<BossStateCombatIdle>(sensor_.get(), movement_.get(), kMaxHp);

    states_[BossStateName::CombatIdle] =
        std::make_unique<BossStateCombatIdle>(sensor_.get(), movement_.get(), kMaxHp);
