...
void HellkainaStateAttackA::Enter(Enemy& enemy)
{
...
void HellkainaStateAttackA::Update(Enemy& enemy, float deltaTime)
{
...
void HellkainaStateAttackA::Exit(Enemy& enemy)
{
