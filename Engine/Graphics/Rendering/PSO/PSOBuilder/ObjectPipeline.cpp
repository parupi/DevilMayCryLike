...
Microsoft::WRL::ComPtr<ID3D12RootSignature> ObjectPipeline::CreateRootSignature(DirectXManager* dxManager)
{
...
Microsoft::WRL::ComPtr<ID3D12PipelineState> ObjectPipeline::CreatePSO(
	DirectXManager* dxManager, ID3D12RootSignature* rootSignature, BlendMode blendMode)
{
	...
	Microsoft::WRL::ComPtr<IDxcBlob> vertexShaderBlob = dxManager->CompileShader(L"./resource/shaders/Object3d.VS.hlsl", L"vs_6_0");
