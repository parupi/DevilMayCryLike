...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginPopupModal(const char* name_, bool* p_open = NULL, ImGuiWindowFlags flags = 0); // return true if the modal is open, and you can start outputting to it.
